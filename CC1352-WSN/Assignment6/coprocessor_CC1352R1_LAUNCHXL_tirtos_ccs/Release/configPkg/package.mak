...
ti.targets.arm.elf.M4F.rootDir ?= C:/ti/ccs1010/ccs/tools/compiler/ti-cgt-arm_20.2.3.LTS
...
.dlls,em4f .dlls: app_cop.pem4f

-include package/cfg/app_cop_pem4f.mak
-include package/cfg/app_cop_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app_cop_pem4f.dep
endif
app_cop.pem4f: package/cfg/app_cop_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
app_cop.pem4f package/cfg/app_cop_pem4f.c: .libraries,em4f
endif

package/cfg/app_cop_pem4f.c package/cfg/app_cop_pem4f.h package/cfg/app_cop_pem4f.xdl: override _PROG_NAME := app_cop.xem4f
package/cfg/app_cop_pem4f.c: package/cfg/app_cop_pem4f.cfg
package/cfg/app_cop_pem4f.xdc.inc: package/cfg/app_cop_pem4f.xdl
package/cfg/app_cop_pem4f.xdl package/cfg/app_cop_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/app_cop_pem4f.cfg
	-$(RM) package/cfg/app_cop_pem4f.dep
	-$(RM) package/cfg/app_cop_pem4f.c
	-$(RM) package/cfg/app_cop_pem4f.xdc.inc

clean,em4f::
	-$(RM) app_cop.pem4f
.executables,em4f .executables: app_cop.xem4f

app_cop.xem4f: |app_cop.pem4f

-include package/cfg/app_cop.xem4f.mak
app_cop.xem4f: package/cfg/app_cop_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/app_cop_pem4f.oem4f   package/cfg/app_cop_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
app_cop.xem4f: export C_DIR=
app_cop.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
app_cop.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

app_cop.test test,em4f test: app_cop.xem4f.test

app_cop.xem4f.test:: app_cop.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app_cop.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app_cop.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,app_cop.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app_cop_pem4f.oem4f,copy : package/cfg/app_cop_pem4f.oem4f
app_cop_pem4f.sem4f,copy : package/cfg/app_cop_pem4f.sem4f

...
extern int CMD_R (int argc, char **argv);
extern int CMD_r (int argc, char **argv);
extern int CMD_G (int argc, char **argv);
extern int CMD_g (int argc, char **argv);
extern int CMD_B (int argc, char **argv);
extern int CMD_b (int argc, char **argv);
extern int CMD_T (int argc, char **argv);
extern int CMD_t (int argc, char **argv);
extern int CMD_S (int argc, char **argv);

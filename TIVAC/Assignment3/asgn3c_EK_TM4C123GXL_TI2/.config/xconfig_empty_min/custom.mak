...
linker.cmd: package/cfg/empty_min_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_min_pem4fcfg.cmd\)\"$""\"C:/Users/kirk/workspace_v10/empty_min_EK_TM4C123GXL_TI/.config/xconfig_empty_min/\1\""' package/cfg/empty_min_pem4f.xdl > $@
